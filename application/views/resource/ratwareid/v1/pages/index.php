...
<body>
<div w3-include-html="nav1.html"></div>
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Home (You're Here!)</li>
  </ol>
</nav>
</div>
</div>
...
<div class="col-sm-12 col-md-6" w3-include-html="home.html"></div>
